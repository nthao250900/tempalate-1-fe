import { ButtonTemplate1, FlexTemplate } from "./FlexTemplate";
...
const mergeTag = {
 ...
 setSubmenu: function () {
  ...
  listDiv.innerHTML = `<div class="se-list-inner se-list-font-size">
      <ul class="se-list-basic">
        <li>
          <button type="button" class="se-btn-list" value="${FlexTemplate}">
            Flex
          </button>
        </li>
        <li>
          <button type="button" class="se-btn-list" value="${ButtonTemplate1}">
            {button 1}
          </button>
        </li>
      </ul>
 ...
 onClick: function (e) {
  ...
  const node = this.util.createElement("div");
